...
## Sobre o Projeto
O **HydroCore** é um sistema completo voltado ao **monitoramento e gestão inteligente de Estações de Tratamento de Água (ETAs)**.  
A plataforma integra uma **API** desenvolvida em **Spring Boot** com um **aplicativo Android** intuitivo, que permite acompanhar em tempo real parâmetros como **pH, turbidez, volume de água tratada e status operacional**.

Além disso, o sistema fornece **relatórios automáticos**, **alertas de manutenção**, **análises estatísticas** e uma **calculadora inteligente** para o **reajuste do pH da água**, considerando o tipo de água, produtos químicos utilizados e condições ambientais.

---

## 🎯 Objetivo
O principal objetivo do HydroCore é **otimizar a operação das ETAs**, garantindo **eficiência no tratamento da água**, **redução de desperdícios** e **aumento da sustentabilidade** por meio de **inovação tecnológica acessível**.

A solução busca conectar profissionais da área de saneamento a uma interface moderna e prática, promovendo **tomadas de decisão baseadas em dados** e reduzindo falhas manuais.

---

## 🌱 Motivação – ODS 9
A criação do HydroCore foi inspirada na **ODS 9 (Indústria, Inovação e Infraestrutura)** da ONU, que incentiva o **desenvolvimento de infraestruturas resilientes**, a **promoção da industrialização sustentável** e o **fomento à inovação**.

Durante a fase de pesquisa, foi identificado que muitas estações de tratamento ainda operam com **monitoramentos manuais e pouco precisos**, o que pode gerar:
- Falhas na qualidade da água tratada;
- Desperdício de insumos químicos;
- Dificuldades de rastreamento de dados históricos.

O HydroCore surge, portanto, como uma **resposta inovadora a esses desafios**, utilizando tecnologia para **modernizar o setor de saneamento**, **aumentar a eficiência operacional** e **preservar recursos naturais**.
...
| Integrante | Função Principal | Contribuições |
|-------------|------------------|----------------|
| **Clara Bartolini** | Desenvolvedora Backend e Mobile | Responsável pelo design da interface, integração com a API, e desenvolvimento do fluxo do app |
...
- Cadastramento de estações de tratamento  
